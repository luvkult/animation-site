...
export const metadata: Metadata = {
  title: "Студия анимации — Визитка",
  description:
    "Создаём 2D/3D анимацию, моушн‑дизайн и объясняющие ролики для брендов и агентств. Полный цикл: концепция, стиль, сториборд, анимация, звук.",
};
